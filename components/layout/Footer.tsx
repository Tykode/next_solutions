    ...
    <footer className="relative bg-[var(--c-bg)] border-t border-white/[0.06] overflow-hidden">
      ...
      <div className="relative border-b border-white/[0.06]">
        <div className="max-w-[1320px] mx-auto px-5 sm:px-8 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link
            href="/rendez-vous"
            className="shrink-0 group inline-flex items-center gap-2 px-6 py-3.5 bg-[#f0a050] hover:bg-[#f5b060] text-[#05080f] text-sm font-bold rounded-full transition-all duration-200 hover:shadow-[0_0_32px_rgba(240,160,80,0.35)]"
          >
